...
CREATE TABLE fighters (id INT AUTO_INCREMENT,forename VARCHAR(20), surname VARCHAR(20), age INT(2), fights INT(4), wins INT(3), losses INT(3), draws INT(3), weight DECIMAL(4, 1) unsigned,PRIMARY KEY(id));
